...
> 마지막 업데이트: 2024-12-12 (Phase 4 Evasion 완료, Phase 2 JNI Discovery 완료)
...
### JNI Discovery
- [x] **unat/discovery/jni_discovery.py** ✅
  - [x] JNI 함수 탐지
  - [x] RegisterNatives 추적
  - [x] Native 메서드 열거
  - [x] JNI 메서드 주소 추출
...
- [x] **frida_scripts/templates/jni_discovery.js** ✅
  - [x] JNI 함수 탐지
  - [x] RegisterNatives 가로채기
  - [x] Native 메서드 열거
...
## ✅ [완료] Phase 4 - Evasion 모듈

### Frida 스크립트
- [x] **frida_scripts/evasion/anti_frida_bypass.js** ✅
  - [x] Named pipe 탐지 우회
  - [x] 포트 스캔 탐지 우회 (27042)
  - [x] 라이브러리 이름 체크 우회
  - [x] /proc 파일 시스템 우회
...
- [x] **frida_scripts/evasion/anti_root_bypass.js** ✅
  - [x] su 바이너리 체크 우회
  - [x] Magisk/SuperSU 탐지 우회
  - [x] RootBeer 라이브러리 우회
  - [x] Build.TAGS 조작
  - [x] Root 앱 패키지 체크 우회

- [x] **frida_scripts/evasion/anti_emulator_bypass.js** ✅
  - [x] Build 속성 스푸핑
  - [x] IMEI/전화번호 스푸핑
  - [x] 센서 가용성 조작
  - [x] 에뮬레이터 파일 숨김
  - [x] SystemProperties 조작

### Python 모듈
- [x] **unat/evasion/evasion_manager.py** ✅
  - [x] Evasion 스크립트 로드 및 관리
  - [x] 스크립트 결합
  - [x] 선택적 우회 활성화

### CLI 통합
- [x] `unat hook --bypass-all` (기본값) ✅
- [x] `unat hook --no-bypass` ✅
- [x] `unat hook --anti-frida` ✅
- [x] `unat hook --anti-root` ✅
- [x] `unat hook --anti-emulator` ✅
